...
let
  sources = {
    ...
    "matrix-puppet-bridge-git://github.com/matrix-hacks/matrix-puppet-bridge#c16ac9f" = {
      name = "matrix-puppet-bridge";
      packageName = "matrix-puppet-bridge";
      version = "1.16.2";
      src = fetchgit {
        url = "git://github.com/matrix-hacks/matrix-puppet-bridge";
        rev = "c16ac9faa2599880c93764a7fb7ce94cabfabb4d";
        sha256 = "e920aed4cfe4244dd04022b56d87c1d5126855f047fa5efaa2c1166778ba6a4e";
      };
    };
    "media-typer-0.3.0" = {
      name = "media-typer";
...
in
{
  "matrix-puppet-hangouts-git://github.com/matrix-hacks/matrix-puppet-hangouts.git" = nodeEnv.buildNodePackage {
    name = "matrix-puppet-hangouts";
    packageName = "matrix-puppet-hangouts";
    version = "1.0.1";
    src = fetchgit {
      url = "git://github.com/matrix-hacks/matrix-puppet-hangouts.git";
      rev = "b055642078ef82a2c543c1424abf5a01b04e71ac";
      sha256 = "8bf4c37201ea299e069a7f18d83ecc60e3459ff6257304deb533ee2a36b23272";
    };
    dependencies = [
      ...
      sources."matrix-puppet-bridge-git://github.com/matrix-hacks/matrix-puppet-bridge#c16ac9f"
